...
# Try to import the package to get the version
try:
    import configmaster
    package_version = configmaster.__version__
except ImportError:
    package_version = '0.0.0' # Fallback version
...
autodoc_default_options = {
    'members': True,
    'undoc-members': True, # Include members without docstrings (use carefully)
...
source_suffix = ['.rst', '.md'] # Add .md for MyST parser

# The master toctree document.
master_doc = 'index' # Sphinx < 2.0 used master_doc, Sphinx >= 2.0 uses root_doc
...
pygments_style = 'sphinx' # Or 'friendly', 'native', etc.
...
# html_theme_options = {} # Consult sphinx_rtd_theme docs if needed
...
latex_documents = [
    (root_doc, 'ConfigMaster.tex', 'ConfigMaster Documentation',
     author, 'manual'),
]
...
man_pages = [
    (root_doc, 'configmaster', 'ConfigMaster Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (root_doc, 'ConfigMaster', 'ConfigMaster Documentation',
     author, 'ConfigMaster', 'Schema-driven configuration management.',
     'Miscellaneous'),
]
