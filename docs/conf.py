...
try:
    ...
    package_version = configguard.__version__
except ImportError:
...
latex_documents = [
    (root_doc, "ConfigGuard.tex", "ConfigGuard Documentation", author, "manual"),
]
...
man_pages = [(root_doc, "configguard", "ConfigGuard Documentation", [author], 1)]
